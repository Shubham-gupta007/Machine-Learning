...
k-means cluster:http://scikit-learn.org/stable/modules/generated/sklearn.cluster.KMeans.html
...
for i in data_dict:
    if(data_dict[i]["from_messages"]=='NaN'):
        pass
         ...
         stock.append(float(data_dict[i]["from_messages"]))
ma = max(stock)
mi = min(stock)
print(ma,mi)
#14368.0 12.0
